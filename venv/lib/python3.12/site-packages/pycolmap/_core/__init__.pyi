...
class BACovariance:
    def get_cam2_cov_from_cam1(
        self,
        image_id1: typing.SupportsInt,
        cam1_from_world: Rigid3d,
        image_id2: typing.SupportsInt,
    ...
    def get_cam_cov_from_world(
        self, image_id: typing.SupportsInt
    ) -> numpy.ndarray[tuple[M, N], numpy.dtype[numpy.float64]] | None:
        """
    ...
    def get_cam_cross_cov_from_world(
        self, image_id1: typing.SupportsInt, image_id2: typing.SupportsInt
    ) -> numpy.ndarray[tuple[M, N], numpy.dtype[numpy.float64]] | None:
        """
        Tangent space covariance in the order [rotation, translation]. If some dimensions are kept constant, the respective rows/columns are omitted. Returns null if image is not a variable in the problem.
        """
    def get_other_params_cov(
        self, param: numpy.ndarray[typing.Any, numpy.dtype[numpy.float64]]
    ) -> numpy.ndarray[tuple[M, N], numpy.dtype[numpy.float64]] | None:
        """
        ...
        """
    def get_point_cov(
        self, point3D_id: typing.SupportsInt
    ) -> numpy.ndarray[tuple[M, N], numpy.dtype[numpy.float64]] | None:
        """
...
class BACovarianceOptions:
    ...
    def experimental_custom_poses(
        self, arg0: collections.abc.Sequence[ExperimentalPoseParam]
    ) -> None: ...
    @property
...
class BACovarianceOptionsParams:
    ...
    ALL: typing.ClassVar[
        BACovarianceOptionsParams
    ]  # value = BACovarianceOptionsParams.ALL
    POINTS: typing.ClassVar[
        BACovarianceOptionsParams
    ]  # value = BACovarianceOptionsParams.POINTS
    POSES: typing.ClassVar[
        BACovarianceOptionsParams
    ]  # value = BACovarianceOptionsParams.POSES
    POSES_AND_POINTS: typing.ClassVar[
        BACovarianceOptionsParams
    ]  # value = BACovarianceOptionsParams.POSES_AND_POINTS
    __members__: typing.ClassVar[
        dict[str, BACovarianceOptionsParams]
    ]  # value = {'POSES': BACovarianceOptionsParams.POSES, 'POINTS': BACovarianceOptionsParams.POINTS, 'POSES_AND_POINTS': BACovarianceOptionsParams.POSES_AND_POINTS, 'ALL': BACovarianceOptionsParams.ALL}
    @staticmethod
...
class Bitmap:
    @staticmethod
    def from_array(
        array: numpy.ndarray[typing.Any, numpy.dtype[numpy.uint8]],
    ) -> Bitmap:
        """
        ...
        """
    @staticmethod
    def read(path: str, as_rgb: bool) -> Bitmap | None:
        """
...
class BundleAdjustmentGauge:
    ...
    THREE_POINTS: typing.ClassVar[
        BundleAdjustmentGauge
    ]  # value = BundleAdjustmentGauge.THREE_POINTS
    TWO_CAMS_FROM_WORLD: typing.ClassVar[
        BundleAdjustmentGauge
    ]  # value = BundleAdjustmentGauge.TWO_CAMS_FROM_WORLD
    UNSPECIFIED: typing.ClassVar[
        BundleAdjustmentGauge
    ]  # value = BundleAdjustmentGauge.UNSPECIFIED
    __members__: typing.ClassVar[
        dict[str, BundleAdjustmentGauge]
    ]  # value = {'UNSPECIFIED': BundleAdjustmentGauge.UNSPECIFIED, 'TWO_CAMS_FROM_WORLD': BundleAdjustmentGauge.TWO_CAMS_FROM_WORLD, 'THREE_POINTS': BundleAdjustmentGauge.THREE_POINTS}
    @staticmethod
    def __repr__(*args, **kwargs):
        """
        __str__(self: object, /) -> str
...
class BundleAdjustmentOptions:
    ...
    def max_num_images_direct_dense_cpu_solver(
    ...
    def max_num_images_direct_dense_gpu_solver(
        self, arg0: typing.SupportsInt
    ) -> None: ...
    @property
    ...
    def max_num_images_direct_sparse_cpu_solver(
        self, arg0: typing.SupportsInt
    ) -> None: ...
    @property
    ...
    def max_num_images_direct_sparse_gpu_solver(
        self, arg0: typing.SupportsInt
    ) -> None: ...
    @property
    ...
    def min_num_residuals_for_cpu_multi_threading(
        self, arg0: typing.SupportsInt
    ) -> None: ...
    @property
    def print_summary(self) -> bool:
...
class Camera:
    ...
    @staticmethod
    def create(
        camera_id: typing.SupportsInt,
        model: CameraModelId,
        focal_length: typing.SupportsFloat,
    ...
    def has_bogus_params(
        self,
        min_focal_length_ratio: typing.SupportsFloat,
        max_focal_length_ratio: typing.SupportsFloat,
        max_extra_param: typing.SupportsFloat,
    ) -> bool:
        """
    ...
    @typing.overload
    def rescale(
        self, new_width: typing.SupportsInt, new_height: typing.SupportsInt
    ) -> None:
        """
...
class CameraMode:
    ...
    __members__: typing.ClassVar[
        dict[str, CameraMode]
    ]  # value = {'AUTO': CameraMode.AUTO, 'SINGLE': CameraMode.SINGLE, 'PER_FOLDER': CameraMode.PER_FOLDER, 'PER_IMAGE': CameraMode.PER_IMAGE}
    @staticmethod
    def __repr__(*args, **kwargs):
        """
        __str__(self: object, /) -> str
...
class CameraModelId:
    ...
    FULL_OPENCV: typing.ClassVar[
        CameraModelId
    ]  # value = CameraModelId.FULL_OPENCV
    ...
    OPENCV_FISHEYE: typing.ClassVar[
        CameraModelId
    ]  # value = CameraModelId.OPENCV_FISHEYE
...
class CopyType:
    ...
    __members__: typing.ClassVar[
        dict[str, CopyType]
    ]  # value = {'copy': CopyType.copy, 'softlink': CopyType.softlink, 'hardlink': CopyType.hardlink}
...
class Correspondence:
    ...
    @typing.overload
    def __init__(
        self, image_id: typing.SupportsInt, point2D_idx: typing.SupportsInt
    ) -> None: ...
    @typing.overload
    def __init__(self, arg0: dict) -> None: ...
    @typing.overload
...
class CorrespondenceGraph:
    ...
    def add_image(
        self, image_id: typing.SupportsInt, num_points2D: typing.SupportsInt
    ) -> None: ...
    ...
    def extract_transitive_correspondences(
        self,
        image_id: typing.SupportsInt,
        point2D_idx: typing.SupportsInt,
        transitivity: typing.SupportsInt,
    ) -> list[Correspondence]: ...
...
class Database:
    ...
    def read_image_with_name(self, name: str) -> Image | None: ...
    def read_keypoints(
        self, image_id: typing.SupportsInt
    ...
    def read_rig_with_sensor(self, sensor_id: sensor_t) -> Rig | None: ...
    ...
    def update_pose_prior(
        self, image_id: typing.SupportsInt, pose_prior: PosePrior
    ) -> None: ...
...
class DatabaseCache:
    ...
    def create(
        database: Database,
        min_num_matches: typing.SupportsInt,
        ignore_watermarks: bool,
        image_names: collections.abc.Set[str],
    ) -> DatabaseCache: ...
    def __init__(self) -> None: ...
...
class DelaunayMeshingOptions:
    ...
    def max_side_length_percentile(
...
class Device:
    ...
    __members__: typing.ClassVar[
        dict[str, Device]
    ]  # value = {'auto': Device.auto, 'cpu': Device.cpu, 'cuda': Device.cuda}
...
class ExhaustivePairGenerator(PairGenerator):
    def __init__(
        self, options: ExhaustivePairingOptions, database: Database
    ) -> None: ...
...
class ExperimentalPoseParam:
    ...
    def qvec(
        self,
    ) -> numpy.ndarray[typing.Any, numpy.dtype[numpy.float64]] | None:
        """
        (NoneType, default: None)
        """
    @qvec.setter
    def qvec(
        self, arg1: numpy.ndarray[typing.Any, numpy.dtype[numpy.float64]]
    ) -> None: ...
    @property
    def tvec(
        self,
...
class FeatureKeypoints:
    ...
    @typing.overload
    def __setitem__(
        self, arg0: typing.SupportsInt, arg1: FeatureKeypoint
    ) -> None: ...
    @typing.overload
...
class FeatureMatches:
    ...
    @typing.overload
    def __setitem__(
        self, arg0: typing.SupportsInt, arg1: FeatureMatch
    ) -> None: ...
    @typing.overload
...
class Frame:
    ...
    def set_cam_from_world(
        self, camera_id: typing.SupportsInt, cam_from_world: Rigid3d
    ) -> None:
        """
...
class GPSTransform:
    ...
    def ecef_to_enu(
        ...
        ref_lat: typing.SupportsFloat,
        ref_lon: typing.SupportsFloat,
    ) -> numpy.ndarray[
        tuple[M, typing.Literal[3]], numpy.dtype[numpy.float64]
    ]: ...
    def ellipsoid_to_ecef(
        self,
        lat_lon_alt: numpy.ndarray[
            tuple[M, typing.Literal[3]], numpy.dtype[numpy.float64]
        ],
    ) -> numpy.ndarray[
        tuple[M, typing.Literal[3]], numpy.dtype[numpy.float64]
    ...
    def ellipsoid_to_utm(
        ...
        numpy.ndarray[tuple[M, typing.Literal[3]], numpy.dtype[numpy.float64]],
        int,
    ]: ...
    def enu_to_ecef(
        self,
        xyz_in_enu: numpy.ndarray[
            tuple[M, typing.Literal[3]], numpy.dtype[numpy.float64]
        ],
        ref_lat: typing.SupportsFloat,
        ref_lon: typing.SupportsFloat,
        ref_alt: typing.SupportsFloat,
    ) -> numpy.ndarray[
        tuple[M, typing.Literal[3]], numpy.dtype[numpy.float64]
    ]: ...
    ...
    def utm_to_ellipsoid(
        self,
        xyz_in_utm: numpy.ndarray[
            tuple[M, typing.Literal[3]], numpy.dtype[numpy.float64]
        ],
        zone: typing.SupportsInt,
        is_north: bool,
    ) -> numpy.ndarray[
        tuple[M, typing.Literal[3]], numpy.dtype[numpy.float64]
    ]: ...
...
class GPSTransfromEllipsoid:
    ...
    GRS80: typing.ClassVar[
        GPSTransfromEllipsoid
    ]  # value = GPSTransfromEllipsoid.GRS80
    WGS84: typing.ClassVar[
        GPSTransfromEllipsoid
    ]  # value = GPSTransfromEllipsoid.WGS84
    __members__: typing.ClassVar[
        dict[str, GPSTransfromEllipsoid]
    ]  # value = {'GRS80': GPSTransfromEllipsoid.GRS80, 'WGS84': GPSTransfromEllipsoid.WGS84}
    @staticmethod
    def __repr__(*args, **kwargs):
        """
        __str__(self: object, /) -> str
...
class Image:
    ...
    def reset_point3D_for_point2D(
        self, point2D_idx: typing.SupportsInt
    ) -> None:
        """
        Set the point as not triangulated, i.e. it is not part of a 3D point track
        """
    def set_point3D_for_point2D(
        self, point2D_Idx: typing.SupportsInt, point3D_id: typing.SupportsInt
    ) -> None:
        """
...
class ImageReaderOptions:
    ...
    def default_focal_length_factor(
        self, arg0: typing.SupportsFloat
    ) -> None: ...
    @property
...
class ImageSelectionMethod:
    ...
    MAX_VISIBLE_POINTS_NUM: typing.ClassVar[
        ImageSelectionMethod
    ]  # value = ImageSelectionMethod.MAX_VISIBLE_POINTS_NUM
    MAX_VISIBLE_POINTS_RATIO: typing.ClassVar[
        ImageSelectionMethod
    ]  # value = ImageSelectionMethod.MAX_VISIBLE_POINTS_RATIO
    MIN_UNCERTAINTY: typing.ClassVar[
        ImageSelectionMethod
    ]  # value = ImageSelectionMethod.MIN_UNCERTAINTY
    __members__: typing.ClassVar[
        dict[str, ImageSelectionMethod]
    ]  # value = {'MAX_VISIBLE_POINTS_NUM': ImageSelectionMethod.MAX_VISIBLE_POINTS_NUM, 'MAX_VISIBLE_POINTS_RATIO': ImageSelectionMethod.MAX_VISIBLE_POINTS_RATIO, 'MIN_UNCERTAINTY': ImageSelectionMethod.MIN_UNCERTAINTY}
    @staticmethod
    def __repr__(*args, **kwargs):
        """
        __str__(self: object, /) -> str
...
class ImportedPairGenerator(PairGenerator):
    def __init__(
        self, options: ImportedPairingOptions, database: Database
    ) -> None: ...
...
class IncrementalMapper:
    ...
    def adjust_local_bundle(
        ...
        image_id: typing.SupportsInt,
        point3D_ids: collections.abc.Set[typing.SupportsInt],
    ) -> LocalBundleAdjustmentReport: ...
    ...
    def find_initial_image_pair(
        ...
        image_id1: typing.SupportsInt,
        image_id2: typing.SupportsInt,
    ) -> tuple[tuple[int, int], Rigid3d] | None: ...
    def find_local_bundle(
        self, options: IncrementalMapperOptions, image_id: typing.SupportsInt
    ) -> list[int]: ...
    ...
    def iterative_global_refinement(
        self,
        max_num_refinements: typing.SupportsInt,
        max_refinement_change: typing.SupportsFloat,
        options: IncrementalMapperOptions,
        ba_options: BundleAdjustmentOptions,
        tri_options: IncrementalTriangulatorOptions,
    ...
    def register_initial_image_pair(
        self,
        options: IncrementalMapperOptions,
        two_view_geometry: typing.SupportsInt,
        image_id1: typing.SupportsInt,
        image_id2: Rigid3d,
    ) -> None: ...
...
class IncrementalMapperCallback:
    ...
    INITIAL_IMAGE_PAIR_REG_CALLBACK: typing.ClassVar[
        IncrementalMapperCallback
    ]  # value = IncrementalMapperCallback.INITIAL_IMAGE_PAIR_REG_CALLBACK
    LAST_IMAGE_REG_CALLBACK: typing.ClassVar[
        IncrementalMapperCallback
    ]  # value = IncrementalMapperCallback.LAST_IMAGE_REG_CALLBACK
    NEXT_IMAGE_REG_CALLBACK: typing.ClassVar[
        IncrementalMapperCallback
    ]  # value = IncrementalMapperCallback.NEXT_IMAGE_REG_CALLBACK
    __members__: typing.ClassVar[
        dict[str, IncrementalMapperCallback]
    ]  # value = {'INITIAL_IMAGE_PAIR_REG_CALLBACK': IncrementalMapperCallback.INITIAL_IMAGE_PAIR_REG_CALLBACK, 'NEXT_IMAGE_REG_CALLBACK': IncrementalMapperCallback.NEXT_IMAGE_REG_CALLBACK, 'LAST_IMAGE_REG_CALLBACK': IncrementalMapperCallback.LAST_IMAGE_REG_CALLBACK}
    @staticmethod
    def __repr__(*args, **kwargs):
        """
        __str__(self: object, /) -> str
...
class IncrementalMapperOptions:
    ...
    def ba_global_prune_points_min_coverage_gain(
        self, arg0: typing.SupportsFloat
    ) -> None: ...
    @property
    ...
    def constant_cameras(
        self, arg0: collections.abc.Set[typing.SupportsInt]
    ) -> None: ...
    @property
...
class IncrementalMapperStatus:
    ...
    BAD_INITIAL_PAIR: typing.ClassVar[
        IncrementalMapperStatus
    ]  # value = IncrementalMapperStatus.BAD_INITIAL_PAIR
    INTERRUPTED: typing.ClassVar[
        IncrementalMapperStatus
    ]  # value = IncrementalMapperStatus.INTERRUPTED
    NO_INITIAL_PAIR: typing.ClassVar[
        IncrementalMapperStatus
    ]  # value = IncrementalMapperStatus.NO_INITIAL_PAIR
    SUCCESS: typing.ClassVar[
        IncrementalMapperStatus
    ]  # value = IncrementalMapperStatus.SUCCESS
    __members__: typing.ClassVar[
        dict[str, IncrementalMapperStatus]
    ]  # value = {'NO_INITIAL_PAIR': IncrementalMapperStatus.NO_INITIAL_PAIR, 'BAD_INITIAL_PAIR': IncrementalMapperStatus.BAD_INITIAL_PAIR, 'SUCCESS': IncrementalMapperStatus.SUCCESS, 'INTERRUPTED': IncrementalMapperStatus.INTERRUPTED}
    @staticmethod
    def __repr__(*args, **kwargs):
        """
        __str__(self: object, /) -> str
...
class IncrementalPipeline:
    ...
    def add_callback(
        self, id: typing.SupportsInt, func: collections.abc.Callable[[], None]
    ) -> None: ...
    def callback(self, id: typing.SupportsInt) -> None: ...
    def check_run_global_refinement(
        self,
        reconstruction: Reconstruction,
        ba_prev_num_reg_images: typing.SupportsInt,
        ba_prev_num_points: typing.SupportsInt,
    ) -> bool: ...
...
class IncrementalPipelineOptions:
    ...
    def ba_global_function_tolerance(
        self, arg0: typing.SupportsFloat
    ) -> None: ...
    @property
    ...
    def ba_global_max_num_iterations(
        self, arg0: typing.SupportsInt
    ) -> None: ...
    @property
    ...
    def ba_global_max_refinement_change(
        self, arg0: typing.SupportsFloat
    ) -> None: ...
    @property
    ...
    def ba_local_function_tolerance(
        self, arg0: typing.SupportsFloat
    ) -> None: ...
    @property
    ...
    def ba_local_max_refinement_change(
        self, arg0: typing.SupportsFloat
    ) -> None: ...
    @property
...
class LossFunctionType:
    ...
    SOFT_L1: typing.ClassVar[
        LossFunctionType
    ]  # value = LossFunctionType.SOFT_L1
    TRIVIAL: typing.ClassVar[
        LossFunctionType
    ]  # value = LossFunctionType.TRIVIAL
    __members__: typing.ClassVar[
        dict[str, LossFunctionType]
    ]  # value = {'TRIVIAL': LossFunctionType.TRIVIAL, 'SOFT_L1': LossFunctionType.SOFT_L1, 'CAUCHY': LossFunctionType.CAUCHY}
    @staticmethod
    def __repr__(*args, **kwargs):
        """
        __str__(self: object, /) -> str
...
class MVSModel:
    ...
    def compute_triangulation_angles(
        self, percentile: typing.SupportsFloat = 50.0
    ) -> list[dict[int, float]]:
        """
    ...
    def get_max_overlapping_images(
        self,
        num_images: typing.SupportsInt,
        min_triangulation_angle: typing.SupportsFloat,
    ) -> list[list[int]]:
        """
...
class Normalization:
    ...
    ]  # value = {'L1_ROOT': Normalization.L1_ROOT, 'L2': Normalization.L2}
    @staticmethod
    def __repr__(*args, **kwargs):
        """
        __str__(self: object, /) -> str
...
class ObservationManager:
    ...
    def __repr__(self) -> str: ...
    def add_observation(
        self, point3D_id: typing.SupportsInt, track_element: TrackElement
    ) -> None:
        """
    ...
    def filter_all_points3D(
        self,
        max_reproj_error: typing.SupportsFloat,
        min_tri_angle: typing.SupportsFloat,
    ) -> int:
        """
    ...
    def filter_points3D_in_images(
        ...
        max_reproj_error: typing.SupportsFloat,
        min_tri_angle: typing.SupportsFloat,
        image_ids: collections.abc.Set[typing.SupportsInt],
    ) -> int:
        """
        Filter 3D points with large reprojection error, negative depth, orinsufficient triangulation angle. Return the number of filtered observations.
        """
    def increment_correspondence_has_point3D(
        ...
        """
    def merge_points3D(
        self, point3D_id1: typing.SupportsInt, point3D_id2: typing.SupportsInt
    ) -> int:
        """
...
class PatchMatchOptions:
    ...
    def filter_geom_consistency_max_cost(
        self, arg0: typing.SupportsFloat
    ) -> None: ...
    @property
    ...
    def filter_min_triangulation_angle(
        self, arg0: typing.SupportsFloat
    ) -> None: ...
    @property
    ...
    def geom_consistency_regularizer(
        self, arg0: typing.SupportsFloat
    ) -> None: ...
    @property
    def gpu_index(self) -> str:
...
class PosePrior:
    ...
    def __init__(
        ...
        coordinate_system: PosePriorCoordinateSystem,
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class PosePriorCoordinateSystem:
    ...
    CARTESIAN: typing.ClassVar[
        PosePriorCoordinateSystem
    ]  # value = PosePriorCoordinateSystem.CARTESIAN
    UNDEFINED: typing.ClassVar[
        PosePriorCoordinateSystem
    ]  # value = PosePriorCoordinateSystem.UNDEFINED
    WGS84: typing.ClassVar[
        PosePriorCoordinateSystem
    ]  # value = PosePriorCoordinateSystem.WGS84
    __members__: typing.ClassVar[
        dict[str, PosePriorCoordinateSystem]
    ]  # value = {'UNDEFINED': PosePriorCoordinateSystem.UNDEFINED, 'WGS84': PosePriorCoordinateSystem.WGS84, 'CARTESIAN': PosePriorCoordinateSystem.CARTESIAN}
    @staticmethod
    def __repr__(*args, **kwargs):
        """
        __str__(self: object, /) -> str
...
class Reconstruction:
    ...
    def compute_bounding_box(
        self,
        min_percentile: typing.SupportsFloat = 0.0,
        max_percentile: typing.SupportsFloat = 1.0,
    ...
    def extract_colors_for_image(
        self, image_id: typing.SupportsInt, path: str
    ) -> bool:
        """
    ...
    def normalize(
        ...
        extent: typing.SupportsFloat = 10.0,
        min_percentile: typing.SupportsFloat = 0.1,
        max_percentile: typing.SupportsFloat = 0.9,
...
class Rig:
    ...
    def add_ref_sensor(self, arg0: sensor_t) -> None:
        ...
        """
    def add_sensor(self, arg0: sensor_t, arg1: Rigid3d | None) -> None:
        """
    ...
    def num_sensors(self) -> int:
        ...
        """
    def sensor_from_rig(self, sensor_id: sensor_t) -> Rigid3d | None:
        """
    ...
    def set_sensor_from_rig(
        self, sensor_id: sensor_t, sensor_from_rig: Rigid3d | None
    ) -> None:
        """
    ...
    def todict(self, recursive: bool = True) -> dict: ...
    @property
    def non_ref_sensors(self) -> dict[sensor_t, Rigid3d | None]:
        """
...
class RigConfig:
    ...
    @cameras.setter
    def cameras(
        self, arg0: collections.abc.Sequence[RigConfigCamera]
    ) -> None: ...
...
class RigConfigCamera:
    ...
    def todict(self, recursive: bool = True) -> dict: ...
    @property
    def cam_from_rig(self) -> Rigid3d | None:
        """
        (NoneType, default: None)
        """
    @cam_from_rig.setter
    def cam_from_rig(self, arg0: Rigid3d | None) -> None: ...
    @property
    def camera(self) -> Camera | None:
        """
        (NoneType, default: None)
        """
    @camera.setter
    def camera(self, arg0: Camera | None) -> None: ...
    @property
...
class SensorType:
    ...
    __members__: typing.ClassVar[
        dict[str, SensorType]
    ]  # value = {'INVALID': SensorType.INVALID, 'CAMERA': SensorType.CAMERA, 'IMU': SensorType.IMU}
    @staticmethod
    def __repr__(*args, **kwargs):
        """
        __str__(self: object, /) -> str
...
class SequentialPairGenerator(PairGenerator):
    def __init__(
        self, options: SequentialPairingOptions, database: Database
    ) -> None: ...
...
class SequentialPairingOptions:
    ...
    def loop_detection_max_num_features(
        self, arg0: typing.SupportsInt
    ) -> None: ...
    @property
    ...
    def loop_detection_num_nearest_neighbors(
        self, arg0: typing.SupportsInt
    ) -> None: ...
    @property
...
class Sift:
    def __init__(
        self,
        options: FeatureExtractionOptions | None = None,
        device: Device = ...,
    ) -> None: ...
    @typing.overload
    def extract(
...
class SpatialPairGenerator(PairGenerator):
    def __init__(
        self, options: SpatialPairingOptions, database: Database
    ) -> None: ...
...
class SyntheticDatasetMatchConfig:
    ...
    CHAINED: typing.ClassVar[
        SyntheticDatasetMatchConfig
    ]  # value = SyntheticDatasetMatchConfig.CHAINED
    EXHAUSTIVE: typing.ClassVar[
        SyntheticDatasetMatchConfig
    ]  # value = SyntheticDatasetMatchConfig.EXHAUSTIVE
    __members__: typing.ClassVar[
        dict[str, SyntheticDatasetMatchConfig]
    ]  # value = {'EXHAUSTIVE': SyntheticDatasetMatchConfig.EXHAUSTIVE, 'CHAINED': SyntheticDatasetMatchConfig.CHAINED}
    @staticmethod
    def __repr__(*args, **kwargs):
        """
        __str__(self: object, /) -> str
...
class SyntheticDatasetOptions:
    ...
    def num_points2D_without_point3D(
        self, arg0: typing.SupportsInt
    ) -> None: ...
    @property
    def num_points3D(self) -> int:
    ...
    def sensor_from_rig_rotation_stddev(
        self, arg0: typing.SupportsFloat
    ) -> None: ...
    @property
    ...
    def sensor_from_rig_translation_stddev(
        self, arg0: typing.SupportsFloat
    ) -> None: ...
    @property
...
class SyntheticImageOptions:
    ...
    def feature_patch_max_brightness(
        self, arg0: typing.SupportsInt
    ) -> None: ...
    @property
...
class SyntheticNoiseOptions:
    ...
    def rig_from_world_rotation_stddev(
        self, arg0: typing.SupportsFloat
    ) -> None: ...
    @property
    ...
    def rig_from_world_translation_stddev(
        self, arg0: typing.SupportsFloat
    ) -> None: ...
...
class Track:
    ...
    @typing.overload
    def __init__(
        self, elements: collections.abc.Sequence[TrackElement]
    ) -> None: ...
    @typing.overload
    def __init__(self, arg0: dict) -> None: ...
    @typing.overload
    ...
    @elements.setter
    def elements(
        self, arg1: collections.abc.Sequence[TrackElement]
    ) -> None: ...
...
class TriangulationResidualType:
    ...
    ANGULAR_ERROR: typing.ClassVar[
        TriangulationResidualType
    ]  # value = TriangulationResidualType.ANGULAR_ERROR
    REPROJECTION_ERROR: typing.ClassVar[
        TriangulationResidualType
    ]  # value = TriangulationResidualType.REPROJECTION_ERROR
    __members__: typing.ClassVar[
        dict[str, TriangulationResidualType]
    ]  # value = {'ANGULAR_ERROR': TriangulationResidualType.ANGULAR_ERROR, 'REPROJECTION_ERROR': TriangulationResidualType.REPROJECTION_ERROR}
    @staticmethod
    def __repr__(*args, **kwargs):
        """
        __str__(self: object, /) -> str
...
class TwoViewGeometryConfiguration:
    ...
    CALIBRATED: typing.ClassVar[
        TwoViewGeometryConfiguration
    ]  # value = TwoViewGeometryConfiguration.CALIBRATED
    CALIBRATED_RIG: typing.ClassVar[
        TwoViewGeometryConfiguration
    ]  # value = TwoViewGeometryConfiguration.CALIBRATED_RIG
    DEGENERATE: typing.ClassVar[
        TwoViewGeometryConfiguration
    ]  # value = TwoViewGeometryConfiguration.DEGENERATE
    MULTIPLE: typing.ClassVar[
        TwoViewGeometryConfiguration
    ]  # value = TwoViewGeometryConfiguration.MULTIPLE
    PANORAMIC: typing.ClassVar[
        TwoViewGeometryConfiguration
    ]  # value = TwoViewGeometryConfiguration.PANORAMIC
    PLANAR: typing.ClassVar[
        TwoViewGeometryConfiguration
    ]  # value = TwoViewGeometryConfiguration.PLANAR
    PLANAR_OR_PANORAMIC: typing.ClassVar[
        TwoViewGeometryConfiguration
    ]  # value = TwoViewGeometryConfiguration.PLANAR_OR_PANORAMIC
    UNCALIBRATED: typing.ClassVar[
        TwoViewGeometryConfiguration
    ]  # value = TwoViewGeometryConfiguration.UNCALIBRATED
    UNDEFINED: typing.ClassVar[
        TwoViewGeometryConfiguration
    ]  # value = TwoViewGeometryConfiguration.UNDEFINED
    WATERMARK: typing.ClassVar[
        TwoViewGeometryConfiguration
    ]  # value = TwoViewGeometryConfiguration.WATERMARK
    __members__: typing.ClassVar[
        dict[str, TwoViewGeometryConfiguration]
    ]  # value = {'UNDEFINED': TwoViewGeometryConfiguration.UNDEFINED, 'DEGENERATE': TwoViewGeometryConfiguration.DEGENERATE, 'CALIBRATED': TwoViewGeometryConfiguration.CALIBRATED, 'CALIBRATED_RIG': TwoViewGeometryConfiguration.CALIBRATED_RIG, 'UNCALIBRATED': TwoViewGeometryConfiguration.UNCALIBRATED, 'PLANAR': TwoViewGeometryConfiguration.PLANAR, 'PANORAMIC': TwoViewGeometryConfiguration.PANORAMIC, 'PLANAR_OR_PANORAMIC': TwoViewGeometryConfiguration.PLANAR_OR_PANORAMIC, 'WATERMARK': TwoViewGeometryConfiguration.WATERMARK, 'MULTIPLE': TwoViewGeometryConfiguration.MULTIPLE}
    @staticmethod
    def __repr__(*args, **kwargs):
        """
        __str__(self: object, /) -> str
...
class TwoViewGeometryOptions:
    ...
    def stationary_matches_max_error(
        self, arg0: typing.SupportsFloat
    ) -> None: ...
    @property
    ...
    def watermark_detection_max_error(
        self, arg0: typing.SupportsFloat
    ) -> None: ...
    @property
    ...
    def watermark_min_inlier_ratio(
        self, arg0: typing.SupportsFloat
    ) -> None: ...
...
class VisualIndex:
    ...
    class QueryOptions:
        ...
        def num_images_after_verification(
            self, arg0: typing.SupportsInt
        ) -> None: ...
        @property
        def num_neighbors(self) -> int:
    ...
    def add(
        self,
        arg0: VisualIndex.IndexOptions,
        arg1: typing.SupportsInt,
        arg2: collections.abc.Sequence[FeatureKeypoint],
        arg3: numpy.ndarray[tuple[M, N], numpy.dtype[numpy.float32]],
    ) -> None: ...
    def build(
        self,
        arg0: VisualIndex.BuildOptions,
        arg1: numpy.ndarray[tuple[M, N], numpy.dtype[numpy.float32]],
    ) -> None: ...
    ...
    def query(
        self,
        arg0: VisualIndex.QueryOptions,
        arg1: numpy.ndarray[tuple[M, N], numpy.dtype[numpy.float32]],
        arg2: collections.abc.Sequence[ImageScore],
    ) -> None: ...
    @typing.overload
    def query(
        self,
        arg0: VisualIndex.QueryOptions,
        arg1: collections.abc.Sequence[FeatureKeypoint],
        arg2: numpy.ndarray[tuple[M, N], numpy.dtype[numpy.float32]],
        arg3: collections.abc.Sequence[ImageScore],
    ) -> None: ...
...
class VocabTreePairGenerator(PairGenerator):
    def __init__(
        self,
        options: VocabTreePairingOptions,
        database: Database,
        query_image_ids: collections.abc.Sequence[typing.SupportsInt] = [],
    ) -> None: ...
...
def align_reconstruction_to_locations(
    ...
    min_common_images: typing.SupportsInt,
    ransac_options: RANSACOptions,
) -> Sim3d | None: ...
def align_reconstruction_to_orig_rig_scales(
    orig_rigs: collections.abc.Mapping[typing.SupportsInt, Rig],
    reconstruction: Reconstruction,
) -> bool: ...
def align_reconstructions_via_points(
    src_reconstruction: Reconstruction,
    tgt_reconstruction: Reconstruction,
    min_common_observations: typing.SupportsInt = 3,
    max_error: typing.SupportsFloat = 0.005,
    min_inlier_ratio: typing.SupportsFloat = 0.9,
) -> Sim3d | None: ...
def align_reconstructions_via_proj_centers(
    src_reconstruction: Reconstruction,
    tgt_reconstruction: Reconstruction,
    max_proj_center_error: typing.SupportsFloat,
) -> Sim3d | None: ...
def align_reconstructions_via_reprojections(
    src_reconstruction: Reconstruction,
    tgt_reconstruction: Reconstruction,
    min_inlier_observations: typing.SupportsFloat = 0.3,
    max_reproj_error: typing.SupportsFloat = 8.0,
) -> Sim3d | None: ...
def apply_rig_config(
    configs: collections.abc.Sequence[RigConfig],
    database: Database,
...
def calculate_triangulation_angle(
    proj_center1: numpy.ndarray[
        tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]
    ],
    proj_center2: numpy.ndarray[
        tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]
    ],
    point3D: numpy.ndarray[
        tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]
...
def compare_reconstructions(
    ...
    min_inlier_observations: typing.SupportsFloat = 0.3,
    max_reproj_error: typing.SupportsFloat = 8.0,
    max_proj_center_error: typing.SupportsFloat = 0.1,
) -> dict | None: ...
...
def create_pose_prior_bundle_adjuster(
    ...
    config: BundleAdjustmentConfig,
    pose_priors: collections.abc.Mapping[typing.SupportsInt, PosePrior],
    reconstruction: Reconstruction,
) -> BundleAdjuster: ...
...
def estimate_affine2d(
    src: numpy.ndarray[tuple[M, typing.Literal[2]], numpy.dtype[numpy.float64]],
    tgt: numpy.ndarray[tuple[M, typing.Literal[2]], numpy.dtype[numpy.float64]],
) -> (
    numpy.ndarray[
        tuple[typing.Literal[2], typing.Literal[3]], numpy.dtype[numpy.float64]
    ]
    | None
):
    """
...
def estimate_and_refine_generalized_absolute_pose(
    ...
    camera_idxs: collections.abc.Sequence[typing.SupportsInt],
    cams_from_rig: collections.abc.Sequence[Rigid3d],
...
def estimate_ba_covariance_from_problem(
    options: BACovarianceOptions, reconstruction: Reconstruction, problem
) -> BACovariance | None:
    """
    Computes covariances for the parameters in a bundle adjustment problem. It is important that the problem has a structure suitable for solving using the Schur complement trick. This is the case for the standard configuration of bundle adjustment problems, but be careful if you modify the underlying problem with custom residuals. Returns null if the estimation was not successful.
    """
...
def estimate_generalized_relative_pose(
    ...
    camera_idxs1: collections.abc.Sequence[typing.SupportsInt],
    camera_idxs2: collections.abc.Sequence[typing.SupportsInt],
    cams_from_rig: collections.abc.Sequence[Rigid3d],
    cameras: collections.abc.Sequence[Camera],
    estimation_options: RANSACOptions = RANSACOptions(),
) -> dict | None: ...
...
def estimate_relative_pose(
    cam_rays1: numpy.ndarray[
        tuple[M, typing.Literal[3]], numpy.dtype[numpy.float64]
    ],
    cam_rays2: numpy.ndarray[
        tuple[M, typing.Literal[3]], numpy.dtype[numpy.float64]
    ],
    options: RANSACOptions = RANSACOptions(),
) -> dict | None:
    """
    Robustly estimate relative pose using LO-RANSAC without non-linear refinement.
    """

def estimate_rigid3d(
...
def estimate_triangulation(
    ...
    cams_from_world: collections.abc.Sequence[Rigid3d],
    cameras: collections.abc.Sequence[Camera],
...
def get_covariance_for_composed_rigid3d(
    left_rigid3d: Rigid3d,
    joint_covar: numpy.ndarray[
        tuple[typing.Literal[12], typing.Literal[12]],
        numpy.dtype[numpy.float64],
    ],
) -> numpy.ndarray[
    tuple[typing.Literal[6], typing.Literal[6]], numpy.dtype[numpy.float64]
...
def get_covariance_for_relative_rigid3d(
    base_rigid3d: Rigid3d,
    target_rigid3d: Rigid3d,
    joint_covar: numpy.ndarray[
        tuple[typing.Literal[12], typing.Literal[12]],
        numpy.dtype[numpy.float64],
    ],
...
def image_pair_to_pair_id(
    image_id1: typing.SupportsInt, image_id2: typing.SupportsInt
) -> int: ...
def import_images(
    database_path: str,
    image_path: str,
...
def interpolate_camera_poses(
    cam1_from_world: Rigid3d, cam2_from_world: Rigid3d, t: typing.SupportsFloat
) -> Rigid3d: ...
...
def triangulate_point(
    cam1_from_world: numpy.ndarray[
        tuple[typing.Literal[3], typing.Literal[4]], numpy.dtype[numpy.float64]
    ],
    cam2_from_world: numpy.ndarray[
        tuple[typing.Literal[3], typing.Literal[4]], numpy.dtype[numpy.float64]
    ],
    cam_point1: numpy.ndarray[
        tuple[typing.Literal[2], typing.Literal[1]], numpy.dtype[numpy.float64]
    ],
    cam_point2: numpy.ndarray[
        tuple[typing.Literal[2], typing.Literal[1]], numpy.dtype[numpy.float64]
    ],
) -> (
    numpy.ndarray[
...
def undistort_image(
    options: UndistortCameraOptions,
    distorted_image: Bitmap,
    distorted_camera: Camera,
) -> tuple[Bitmap, Camera]:
    """
...
def undistort_images(
    ...
    copy_policy: CopyType = ...,
    num_patch_match_src_images: typing.SupportsInt = 20,
